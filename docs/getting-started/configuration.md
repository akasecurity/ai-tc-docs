...
- `~/.aka/settings/settings.json` — onboarding preferences (`policy`,
  `historicalAccess`), written by `/aka:setup` or `aka init`. See
  [Claude Code plugin → Configuration](../plugins/claude-code.md#configuration).
